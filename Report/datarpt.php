...
<?php include_once "datarptinfo.php" ?>
<?php
...
$data_rpt = NULL; // Initialize page object first

class crdata_rpt extends crdata {
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'data', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fdatarpt";
	}
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_data\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_data',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fdatarpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fdatarpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fdatarpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($data_rpt)) $data_rpt = new crdata_rpt();
...
// Create page object
var data_rpt = new ewr_Page("data_rpt");

// Page properties
data_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = data_rpt.PageID;

// Extend page with Chart_Rendering function
data_rpt.Chart_Rendering = 
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ID"><div class="data_ID"><span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ID">
<?php if ($Page->SortUrl($Page->ID) == "") { ?>
		<div class="ewTableHeaderBtn data_ID">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer data_ID" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ID) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="title"><div class="data_title"><span class="ewTableHeaderCaption"><?php echo $Page->title->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="title">
<?php if ($Page->SortUrl($Page->title) == "") { ?>
		<div class="ewTableHeaderBtn data_title">
			<span class="ewTableHeaderCaption"><?php echo $Page->title->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer data_title" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->title) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->title->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="url"><div class="data_url"><span class="ewTableHeaderCaption"><?php echo $Page->url->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="url">
<?php if ($Page->SortUrl($Page->url) == "") { ?>
		<div class="ewTableHeaderBtn data_url">
			<span class="ewTableHeaderCaption"><?php echo $Page->url->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer data_url" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->url) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->url->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user"><div class="data_user"><span class="ewTableHeaderCaption"><?php echo $Page->user->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user">
<?php if ($Page->SortUrl($Page->user) == "") { ?>
		<div class="ewTableHeaderBtn data_user">
			<span class="ewTableHeaderCaption"><?php echo $Page->user->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer data_user" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->user) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->user->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_data_ID"<?php echo $Page->ID->ViewAttributes() ?>><?php echo $Page->ID->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->title->Visible) { ?>
		<td data-field="title"<?php echo $Page->title->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_data_title"<?php echo $Page->title->ViewAttributes() ?>><?php echo $Page->title->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->url->Visible) { ?>
		<td data-field="url"<?php echo $Page->url->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_data_url"<?php echo $Page->url->ViewAttributes() ?>><?php echo $Page->url->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->user->Visible) { ?>
		<td data-field="user"<?php echo $Page->user->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_data_user"<?php echo $Page->user->ViewAttributes() ?>><?php echo $Page->user->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
