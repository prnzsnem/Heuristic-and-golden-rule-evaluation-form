...
define("EWR_PROJECT_ID", "{7F45C9B5-7587-4392-8B05-3F952549C7C4}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "myprojecthci", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'znAprpnB8PjN1OAv', TRUE); // Random key for encryption
