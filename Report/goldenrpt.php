...
<?php include_once "goldenrptinfo.php" ?>
<?php
...
$golden_rpt = NULL; // Initialize page object first

class crgolden_rpt extends crgolden {
	...
	function __construct() {
		...
		// Table object (golden)
		if (!isset($GLOBALS["golden"])) {
			$GLOBALS["golden"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["golden"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'golden', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fgoldenrpt";
	}
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_golden\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_golden',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fgoldenrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fgoldenrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fgoldenrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	//		$rs->MoveFirst(); // NOTE: no need to move position
				...
				$this->FirstRowData['md'] = ewr_Conv($rs->fields('md'),200);
...
// Create page object
if (!isset($golden_rpt)) $golden_rpt = new crgolden_rpt();
...
// Create page object
var golden_rpt = new ewr_Page("golden_rpt");

// Page properties
golden_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = golden_rpt.PageID;

// Extend page with Chart_Rendering function
golden_rpt.Chart_Rendering = 
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ID"><div class="golden_ID"><span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ID">
<?php if ($Page->SortUrl($Page->ID) == "") { ?>
		<div class="ewTableHeaderBtn golden_ID">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_ID" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ID) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="qa"><div class="golden_qa"><span class="ewTableHeaderCaption"><?php echo $Page->qa->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="qa">
<?php if ($Page->SortUrl($Page->qa) == "") { ?>
		<div class="ewTableHeaderBtn golden_qa">
			<span class="ewTableHeaderCaption"><?php echo $Page->qa->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_qa" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->qa) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->qa->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ra"><div class="golden_ra"><span class="ewTableHeaderCaption"><?php echo $Page->ra->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ra">
<?php if ($Page->SortUrl($Page->ra) == "") { ?>
		<div class="ewTableHeaderBtn golden_ra">
			<span class="ewTableHeaderCaption"><?php echo $Page->ra->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_ra" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ra) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ra->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ma"><div class="golden_ma"><span class="ewTableHeaderCaption"><?php echo $Page->ma->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ma">
<?php if ($Page->SortUrl($Page->ma) == "") { ?>
		<div class="ewTableHeaderBtn golden_ma">
			<span class="ewTableHeaderCaption"><?php echo $Page->ma->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_ma" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ma) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ma->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="qb"><div class="golden_qb"><span class="ewTableHeaderCaption"><?php echo $Page->qb->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="qb">
<?php if ($Page->SortUrl($Page->qb) == "") { ?>
		<div class="ewTableHeaderBtn golden_qb">
			<span class="ewTableHeaderCaption"><?php echo $Page->qb->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_qb" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->qb) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->qb->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="rb"><div class="golden_rb"><span class="ewTableHeaderCaption"><?php echo $Page->rb->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="rb">
<?php if ($Page->SortUrl($Page->rb) == "") { ?>
		<div class="ewTableHeaderBtn golden_rb">
			<span class="ewTableHeaderCaption"><?php echo $Page->rb->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_rb" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->rb) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->rb->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="mb"><div class="golden_mb"><span class="ewTableHeaderCaption"><?php echo $Page->mb->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="mb">
<?php if ($Page->SortUrl($Page->mb) == "") { ?>
		<div class="ewTableHeaderBtn golden_mb">
			<span class="ewTableHeaderCaption"><?php echo $Page->mb->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_mb" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->mb) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->mb->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="qc"><div class="golden_qc"><span class="ewTableHeaderCaption"><?php echo $Page->qc->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="qc">
<?php if ($Page->SortUrl($Page->qc) == "") { ?>
		<div class="ewTableHeaderBtn golden_qc">
			<span class="ewTableHeaderCaption"><?php echo $Page->qc->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_qc" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->qc) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->qc->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="rc"><div class="golden_rc"><span class="ewTableHeaderCaption"><?php echo $Page->rc->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="rc">
<?php if ($Page->SortUrl($Page->rc) == "") { ?>
		<div class="ewTableHeaderBtn golden_rc">
			<span class="ewTableHeaderCaption"><?php echo $Page->rc->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_rc" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->rc) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->rc->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="mc"><div class="golden_mc"><span class="ewTableHeaderCaption"><?php echo $Page->mc->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="mc">
<?php if ($Page->SortUrl($Page->mc) == "") { ?>
		<div class="ewTableHeaderBtn golden_mc">
			<span class="ewTableHeaderCaption"><?php echo $Page->mc->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_mc" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->mc) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->mc->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="qd"><div class="golden_qd"><span class="ewTableHeaderCaption"><?php echo $Page->qd->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="qd">
<?php if ($Page->SortUrl($Page->qd) == "") { ?>
		<div class="ewTableHeaderBtn golden_qd">
			<span class="ewTableHeaderCaption"><?php echo $Page->qd->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_qd" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->qd) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->qd->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="rd"><div class="golden_rd"><span class="ewTableHeaderCaption"><?php echo $Page->rd->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="rd">
<?php if ($Page->SortUrl($Page->rd) == "") { ?>
		<div class="ewTableHeaderBtn golden_rd">
			<span class="ewTableHeaderCaption"><?php echo $Page->rd->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_rd" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->rd) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->rd->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="md"><div class="golden_md"><span class="ewTableHeaderCaption"><?php echo $Page->md->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="md">
<?php if ($Page->SortUrl($Page->md) == "") { ?>
		<div class="ewTableHeaderBtn golden_md">
			<span class="ewTableHeaderCaption"><?php echo $Page->md->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_md" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->md) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->md->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="qe"><div class="golden_qe"><span class="ewTableHeaderCaption"><?php echo $Page->qe->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="qe">
<?php if ($Page->SortUrl($Page->qe) == "") { ?>
		<div class="ewTableHeaderBtn golden_qe">
			<span class="ewTableHeaderCaption"><?php echo $Page->qe->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_qe" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->qe) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->qe->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="re"><div class="golden_re"><span class="ewTableHeaderCaption"><?php echo $Page->re->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="re">
<?php if ($Page->SortUrl($Page->re) == "") { ?>
		<div class="ewTableHeaderBtn golden_re">
			<span class="ewTableHeaderCaption"><?php echo $Page->re->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_re" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->re) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->re->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="me"><div class="golden_me"><span class="ewTableHeaderCaption"><?php echo $Page->me->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="me">
<?php if ($Page->SortUrl($Page->me) == "") { ?>
		<div class="ewTableHeaderBtn golden_me">
			<span class="ewTableHeaderCaption"><?php echo $Page->me->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_me" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->me) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->me->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="qf"><div class="golden_qf"><span class="ewTableHeaderCaption"><?php echo $Page->qf->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="qf">
<?php if ($Page->SortUrl($Page->qf) == "") { ?>
		<div class="ewTableHeaderBtn golden_qf">
			<span class="ewTableHeaderCaption"><?php echo $Page->qf->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_qf" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->qf) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->qf->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="rf"><div class="golden_rf"><span class="ewTableHeaderCaption"><?php echo $Page->rf->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="rf">
<?php if ($Page->SortUrl($Page->rf) == "") { ?>
		<div class="ewTableHeaderBtn golden_rf">
			<span class="ewTableHeaderCaption"><?php echo $Page->rf->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_rf" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->rf) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->rf->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="mf"><div class="golden_mf"><span class="ewTableHeaderCaption"><?php echo $Page->mf->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="mf">
<?php if ($Page->SortUrl($Page->mf) == "") { ?>
		<div class="ewTableHeaderBtn golden_mf">
			<span class="ewTableHeaderCaption"><?php echo $Page->mf->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_mf" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->mf) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->mf->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="qg"><div class="golden_qg"><span class="ewTableHeaderCaption"><?php echo $Page->qg->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="qg">
<?php if ($Page->SortUrl($Page->qg) == "") { ?>
		<div class="ewTableHeaderBtn golden_qg">
			<span class="ewTableHeaderCaption"><?php echo $Page->qg->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_qg" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->qg) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->qg->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="rg"><div class="golden_rg"><span class="ewTableHeaderCaption"><?php echo $Page->rg->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="rg">
<?php if ($Page->SortUrl($Page->rg) == "") { ?>
		<div class="ewTableHeaderBtn golden_rg">
			<span class="ewTableHeaderCaption"><?php echo $Page->rg->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_rg" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->rg) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->rg->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="mg"><div class="golden_mg"><span class="ewTableHeaderCaption"><?php echo $Page->mg->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="mg">
<?php if ($Page->SortUrl($Page->mg) == "") { ?>
		<div class="ewTableHeaderBtn golden_mg">
			<span class="ewTableHeaderCaption"><?php echo $Page->mg->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_mg" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->mg) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->mg->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="qh"><div class="golden_qh"><span class="ewTableHeaderCaption"><?php echo $Page->qh->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="qh">
<?php if ($Page->SortUrl($Page->qh) == "") { ?>
		<div class="ewTableHeaderBtn golden_qh">
			<span class="ewTableHeaderCaption"><?php echo $Page->qh->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_qh" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->qh) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->qh->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="rh"><div class="golden_rh"><span class="ewTableHeaderCaption"><?php echo $Page->rh->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="rh">
<?php if ($Page->SortUrl($Page->rh) == "") { ?>
		<div class="ewTableHeaderBtn golden_rh">
			<span class="ewTableHeaderCaption"><?php echo $Page->rh->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_rh" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->rh) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->rh->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="mh"><div class="golden_mh"><span class="ewTableHeaderCaption"><?php echo $Page->mh->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="mh">
<?php if ($Page->SortUrl($Page->mh) == "") { ?>
		<div class="ewTableHeaderBtn golden_mh">
			<span class="ewTableHeaderCaption"><?php echo $Page->mh->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer golden_mh" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->mh) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->mh->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_ID"<?php echo $Page->ID->ViewAttributes() ?>><?php echo $Page->ID->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->qa->Visible) { ?>
		<td data-field="qa"<?php echo $Page->qa->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_qa"<?php echo $Page->qa->ViewAttributes() ?>><?php echo $Page->qa->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->ra->Visible) { ?>
		<td data-field="ra"<?php echo $Page->ra->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_ra"<?php echo $Page->ra->ViewAttributes() ?>><?php echo $Page->ra->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->ma->Visible) { ?>
		<td data-field="ma"<?php echo $Page->ma->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_ma"<?php echo $Page->ma->ViewAttributes() ?>><?php echo $Page->ma->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->qb->Visible) { ?>
		<td data-field="qb"<?php echo $Page->qb->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_qb"<?php echo $Page->qb->ViewAttributes() ?>><?php echo $Page->qb->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->rb->Visible) { ?>
		<td data-field="rb"<?php echo $Page->rb->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_rb"<?php echo $Page->rb->ViewAttributes() ?>><?php echo $Page->rb->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->mb->Visible) { ?>
		<td data-field="mb"<?php echo $Page->mb->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_mb"<?php echo $Page->mb->ViewAttributes() ?>><?php echo $Page->mb->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->qc->Visible) { ?>
		<td data-field="qc"<?php echo $Page->qc->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_qc"<?php echo $Page->qc->ViewAttributes() ?>><?php echo $Page->qc->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->rc->Visible) { ?>
		<td data-field="rc"<?php echo $Page->rc->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_rc"<?php echo $Page->rc->ViewAttributes() ?>><?php echo $Page->rc->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->mc->Visible) { ?>
		<td data-field="mc"<?php echo $Page->mc->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_mc"<?php echo $Page->mc->ViewAttributes() ?>><?php echo $Page->mc->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->qd->Visible) { ?>
		<td data-field="qd"<?php echo $Page->qd->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_qd"<?php echo $Page->qd->ViewAttributes() ?>><?php echo $Page->qd->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->rd->Visible) { ?>
		<td data-field="rd"<?php echo $Page->rd->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_rd"<?php echo $Page->rd->ViewAttributes() ?>><?php echo $Page->rd->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->md->Visible) { ?>
		<td data-field="md"<?php echo $Page->md->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_md"<?php echo $Page->md->ViewAttributes() ?>><?php echo $Page->md->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->qe->Visible) { ?>
		<td data-field="qe"<?php echo $Page->qe->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_qe"<?php echo $Page->qe->ViewAttributes() ?>><?php echo $Page->qe->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->re->Visible) { ?>
		<td data-field="re"<?php echo $Page->re->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_re"<?php echo $Page->re->ViewAttributes() ?>><?php echo $Page->re->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->me->Visible) { ?>
		<td data-field="me"<?php echo $Page->me->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_me"<?php echo $Page->me->ViewAttributes() ?>><?php echo $Page->me->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->qf->Visible) { ?>
		<td data-field="qf"<?php echo $Page->qf->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_qf"<?php echo $Page->qf->ViewAttributes() ?>><?php echo $Page->qf->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->rf->Visible) { ?>
		<td data-field="rf"<?php echo $Page->rf->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_rf"<?php echo $Page->rf->ViewAttributes() ?>><?php echo $Page->rf->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->mf->Visible) { ?>
		<td data-field="mf"<?php echo $Page->mf->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_mf"<?php echo $Page->mf->ViewAttributes() ?>><?php echo $Page->mf->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->qg->Visible) { ?>
		<td data-field="qg"<?php echo $Page->qg->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_qg"<?php echo $Page->qg->ViewAttributes() ?>><?php echo $Page->qg->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->rg->Visible) { ?>
		<td data-field="rg"<?php echo $Page->rg->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_rg"<?php echo $Page->rg->ViewAttributes() ?>><?php echo $Page->rg->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->mg->Visible) { ?>
		<td data-field="mg"<?php echo $Page->mg->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_mg"<?php echo $Page->mg->ViewAttributes() ?>><?php echo $Page->mg->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->qh->Visible) { ?>
		<td data-field="qh"<?php echo $Page->qh->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_qh"<?php echo $Page->qh->ViewAttributes() ?>><?php echo $Page->qh->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->rh->Visible) { ?>
		<td data-field="rh"<?php echo $Page->rh->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_rh"<?php echo $Page->rh->ViewAttributes() ?>><?php echo $Page->rh->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->mh->Visible) { ?>
		<td data-field="mh"<?php echo $Page->mh->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_golden_mh"<?php echo $Page->mh->ViewAttributes() ?>><?php echo $Page->mh->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "goldenrptpager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
</div>
